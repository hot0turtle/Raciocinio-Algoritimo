...
def  rio():
    hide_choices()
    text_area.insert('end', "Humm, voce começou a passar mal, o que deseja fazer?O sol começa a se pôr, e a temperatura cai rapidamente. O vento aumenta, e você sabe que precisa se preparar para a noite. Após algum tempo, você encontra destroços do barco, incluindo madeira, cordas e pedaços de tecido.\n")
    set_choices(" Construir o abrigo", abrigo, " Construir o abrigo", fogueira)
...
def go_right():
    ...
    progress_label.config(text=str(int(new_value)))
    hide_choices()
    text_area.insert('end', "Caminhar pela praia e procurar sinais de vida.\n")
...
text_area.insert('end', "Welcome to the Text Based Game!\n")
